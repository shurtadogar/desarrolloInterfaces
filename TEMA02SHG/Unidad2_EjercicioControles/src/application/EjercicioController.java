...
public class EjercicioController {
    ...
    private void initialize() {   
    	...
    	// FileInputStream toma como carpeta raíz la ruta del proyecto 
    	...
    	// Hay otras alternativas a FileInputStream que requieren tener las imágenes a partir de la carpeta src
